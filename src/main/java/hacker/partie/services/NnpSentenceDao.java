 ...
 * 
 */
public class NnpSentenceDao {

    // Variablen, die anzeigen sollen, ob das Speichern, Updaten oder Löschen
    // eines Datensatzes erfolgreich war

    /**
     * Es werden alle Datensätze, die in der Tabelle "sentences_nnp" vorhanden sind, angezeigt
     * 
     * @return sentenceList
     */
    public static List<ThreePartSentence> findAll() {
        ...
        try {
            ...
            myPreparedStatement = connect
                .prepareStatement("SELECT * FROM sentences_nnp;");
    ...
    /**
     * Methode zum Speichern eines neuen Datensatzes in die Tabelle "sentences_nnp"
     * 
     * @param toSave
     * @return successful
     */
    public static boolean save(ThreePartSentence toSave) {
        ...
        try {
            ...
            myPreparedStatement = connect
                .prepareStatement("INSERT INTO sentences_nnp VALUES(default,?, ?, ?)");
    ...
    /**
     * Methode zum Erstellen eines zufällig zusammengesetzten Sentence aus den Tabellenfeldern der Tabelle "sentences_nnp"
     * original von jens
     * 
    ...
    private static String get_subject() {
        ...
        try {
            connect = DatabaseConnection.connectDB();
            myPreparedStatement = connect
                .prepareStatement("select sentences_nnp.object from sentences_nnp order by random() limit 1");
            myResultSet = myPreparedStatement.executeQuery();
            while (myResultSet.next()) {
    ...
    private static String get_verb() {
        ...
        try {
            connect = DatabaseConnection.connectDB();
            myPreparedStatement = connect
                .prepareStatement("select sentences_nnp.verb from sentences_nnp order by random() limit 1");
            myResultSet = myPreparedStatement.executeQuery();
            while (myResultSet.next()) {
    ...
    private static String get_complement() {
        ...
        try {
            connect = DatabaseConnection.connectDB();
            myPreparedStatement = connect
                .prepareStatement("select sentences_nnp.complement from sentences_nnp order by random() limit 1");
            myResultSet = myPreparedStatement.executeQuery();
    ...
    /**
     * Methode zum Löschen eines Datensatzes aus der Tabelle "sentences_nnp"
     * 
     * @param id
     * @return successful
     */
    public static boolean delete(int id) {
        ...
        try {
            connect = DatabaseConnection.connectDB();
            myPreparedStatement = connect
                .prepareStatement("DELETE FROM sentences_nnp WHERE id = "
                    + id + ";");
    ...
    public static int count() {
        ...
        try {
            connect = DatabaseConnection.connectDB();
            myPreparedStatement = connect
                .prepareStatement("SELECT COUNT(*) FROM sentences_nnp;");
            myResultSet = myPreparedStatement.executeQuery();
            myResultSet.next();
