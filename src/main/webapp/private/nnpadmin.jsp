...
<body>
	...
	<form action="${pageContext.request.contextPath}/private/nnpadmin"
		method="post">
		<input type="text" name="subject" placeholder="Name:"> <input
			type="text" name="verb" placeholder="Name"> <input
			type="text" name="complement" placeholder="Partizip">
